...
local data = {
    ...
    ["Abyssal Mask"] = {
        ...
        ["recipe"]              = {"Catalyst of Aeons", "Spectre's Cowl"},
        ["buy"]                 = 3000,
    },
    ["Aegis of the Legion"] = {
        ["id"]                  = 3105,
    ...
    ["Archangel's Staff"] = {
        ...
        ["effects"] = {
            ...
            ["pass2"] = {
                ["name"]        = "Mana Charge",
                ["unique"]      = true,
                ["description"] = "Grants a charge every 8 seconds, up to 4 charges. Affecting an enemy or ally with an [[champion ability|ability]] consumes a charge to grant {{as|3 '''bonus''' mana}}, increased to {{as|6|mana}} if they are a champion, up to a '''maximum''' of {{as|360 '''bonus''' mana}}.",
            },
            ["pass3"] = {
                ["description"] = "Transforms into {{ii|Seraph's Embrace}} at {{as|360 '''bonus''' mana}}.",
            },
        },
        ["recipe"]              = {"Tear of the Goddess", "Kindlegem", "Needlessly Large Rod"},
        ["buy"]                 = 3000,
    },
    ["Ardent Censer"] = {
        ["id"]                  = 3504,
        ...
        ["effects"] = {
            ["pass"] = {
                ["name"]        = "Sanctify",
                ["unique"]      = true,
                ["description"] = "{{tip|Heal|Healing}} or {{tip|shield|shielding}} allied champions (''excluding yourself'') enhances you and them for 6 seconds, granting {{as|{{pp|type=target's level|key=%|10 to 30}} '''bonus''' attack speed|attack speed}} and {{as|{{pp|type=target's level|5 to 20}} '''bonus''' magic damage|magic damage}} [[on-hit]] on basic attacks.",
            },
        },
    ...
    ["Bloodthirster"] = {
        ...
        ["effects"] = {
            ["pass"] = {
                ["name"]        = "Ichorshield",
                ["unique"]      = true,
                ["description"] = "Convert the {{tip|healing}} received from {{sti|life steal}} in excess of {{as|'''maximum''' health}} into a {{tip|shield}} for up to {{pp|180 to 450 for 10|1;10 to 18}}, which slowly decays after not dealing or taking damage for 25 seconds.",
            },
        },
    ...
    ["Chemtech Putrifier"] = {
        ...
        ["effects"] = {
            ["pass"] = {   
                ["name"]        = "Puffcap Toxin",
                ["unique"]      = true,
                ["description"] = "Dealing damage to enemy champions inflicts them with {{tip|Grievous Wounds}} for 3 seconds.",
            },
        },
        ["recipe"]              = {"Oblivion Orb", "Forbidden Idol"},
        ["buy"]                 = 2300,
    },
    ["Cloak of Agility"] = {
        ["id"]                  = 1018,
    ...
    ["Cosmic Drive"] = {
        ...
        ["effects"] = {
            ["pass"] = {   
                ["name"]        = "Spelldance",
                ["unique"]      = true,
                ["description"] = "After dealing 3 instances of damage from basic attacks or {{tip|ability damage}} to champions within 3 seconds, gain {{as|15% '''bonus''' movement speed}}, decaying to {{as|5%|ms}} over 2 seconds, and {{as|40 ability power}} for 5 seconds, refreshing on damage dealt to champions though not resetting the effect.",
            },
        },
        ["recipe"]              = {"Fiendish Codex", "Aether Wisp", "Amplifying Tome"},
        ["buy"]                 = 3000,
    },
    ["Crown of the Shattered Queen"] = {
        ...
        ["effects"] = {
            ["pass"] = {
                ["name"]        = "Safeguard",
                ["unique"]      = true,
                ["description"] = "Become ''Safeguarded'' to reduce incoming champion damage by 75%, lingering for {{fd|1.5}} seconds after taking damage from a champion.",
                ["cd"]          = "40 (restarts upon taking damage from champions)",
            },
            ["pass2"] = {
                ["name"]        = "Poise",
    ...
    ["Death's Dance"] = {
        ...
        ["effects"] = {
            ...
            ["pass2"] = {
                ["name"]        = "Defy",
                ["unique"]      = true,
                ["description"] = "If an enemy champion dies within 3 seconds of you damaging them, removes ''Ignore Pain's'' remaining stored damage and {{tip|heals}} you for {{as|50% '''bonus''' AD}} over 2 seconds.",
            },
        },
        ["recipe"]              = {"Pickaxe", "Chain Vest", "Pickaxe"},
        ["buy"]                 = 3300,
    },
    ["Death's Daughter"] = {
        ["id"]                  = 3902,
    ...
    ["Demonic Embrace"] = {
        ...
        ["effects"] = {
            ...
            ["pass2"] = {
                ["name"]        = "Azakana Gaze",
                ["unique"]      = true,
                ["description"] = "Dealing {{tip|ability damage}} curses enemies, causing them to take{{ft|{{as|{{rd|{{fd|6.4}}%|4%}} of their '''maximum''' health}} as {{as|'''total''' magic damage}} over 4 seconds, capped at 400 against monsters.|{{as|{{rd|{{fd|1.6}}%|1%}} of their '''maximum''' health}} as {{as|magic damage}} every second over 4 seconds, capped at 40 against monsters.}}",
            },
        },
    ...
    ["Eclipse"] = {
        ...
        ["effects"] = {
            ["pass"] = {   
                ...
                ["unique"]      = true,
                ["description"] = "Hitting an enemy champion with 2 separate attacks or abilities within {{fd|1.5}} seconds deals {{as|'''bonus''' physical damage}} equal to {{as|{{rd|6%|3%}} of target's '''maximum''' health}} and grants you {{as|15% '''bonus''' movement speed}} and a {{tip|shield}} for {{rd|160|80}} {{as|(+ {{rd|35%|{{fd|17.5}}%}} '''bonus''' AD)}} for 2 seconds.",
                ["cd"]          = "{{rd|6|12}}",
            },
            ["mythic"]          = {
            	["armpen"]			= 4,
    ...
    ["Evenshroud"] = {
        ...
        ["effects"] = {
            ["pass"] = {
                ["name"]        = "Coruscation",
                ["unique"]      = true,
                ["description"] = "Becoming affected by or applying an {{tip|immobilize|immobilizing}} or {{tip|ground|grounding}} effect to or from an enemy champion affects them and all enemy champions within {{tip|cr|icononly = true}} 600 units of you with ''Repent'', increasing the damage they take by 10% for 5 seconds.",
            },
            ["mythic"]          = {
            	["armor"]			= 5,
            	["mr"]			    = 5,
    ...
    ["Frostfang"] = {
        ...
        ["effects"] = {
            ...
            ["pass"] = {
                ["name"]        = "Tribute",
                ["unique"]      = true,
                ["description"] = "Grants a charge every 12 seconds, up to 3 charges. If an allied champion is {{tt|nearby|2000 range}}, damaging basic attacks and abilities against champions and structures consume a charge, up to one per attack or cast. Consuming a charge grants {{g|20}}. ''Receive diminishing gold from excessive minion kills.''",
            },
            ["pass2"] = {
                ["name"]        = "Quest",
                ["unique"]      = true,
                ["description"] = "Earn {{g|500}} using this item to upgrade to {{ii|Shard of True Ice}}, increasing the ''Warding'' active to instead have 4 wards in stock.",
            },
        },
    ...
    ["Frozen Heart"] = {
        ...
        ["effects"] = {
            ["pass"] = {
                ["name"]        = "Rock Solid",
                ["unique"]      = true,
                ["description"] = "Every first incoming instance of {{tt|post-mitigation|Damage calculated after modifiers}} {{tip|basic damage}} per {{tip|cast instance}} is [[Damage modifier|reduced]] by 5 {{as|(+ {{fd|3.5}} per 1000 '''maximum''' health)}}, '''maximum''' 40% reduction each.",
            },
            ["pass2"] = {
    ...
    ["Gustwalker Hatchling"] = {
        ...
        ["stats"] = {
            ["spec"]            = "+20% damage against non-epic [[monster]]s",
        },
        ["effects"] = {
            ["pass"] = {
                ["unique"]      = true,
    ...
    ["Harrowing Crescent"] = {
        ...
        ["effects"] = {
            ...
            ["pass2"] = {
                ["name"]        = "Quest",
                ["unique"]      = true,
                ["description"] = "Earn {{g|500}} using this item to upgrade to {{ii|Black Mist Scythe}}, increasing the ''Warding'' active to instead have 4 wards in stock.",
            },
        },
    ...
    ["Heartsteel"] = {
        ...
        ["recipe"]              = {"Kindlegem", "Crystalline Bracer", "Giant's Belt"},
        ["buy"]                 = 3200,
    },
    ["Hexdrinker"] = {
        ["id"]                  = 3155,
    ...
    ["Iceborn Gauntlet"] = {
        ...
        ["recipe"]              = {"Sheen", "Kindlegem", "Chain Vest"},
        ["buy"]                 = 3000,
    },
    ["Immortal Shieldbow"] = {
        ["id"]                  = 6673,
    ...
    ["Infinity Edge"] = {
        ...
        ["effects"] = {
            ["pass"] = {
                ["name"]        = "Perfection",
                ["unique"]      = true,
                ["description"] = "Gain {{as|35% '''bonus''' critical strike damage}} if you have at least {{as|40% critical strike chance}}.",
            },
        },
    ...
    ["Jak'Sho, The Protean"] = {
        ...
        ["recipe"]              = {"Aegis of the Legion", "Kindlegem", "Ruby Crystal"},
        ["buy"]                 = 3200,
    },
    ["Kindlegem"] = {
        ["id"]                  = 3067,
    ...
    ["Knight's Vow"] = {
        ...
        ["effects"] = {
            ["act"] = {
                ["name"]        = "Pledge",
                ["unique"]      = true,
                ["description"] = "Designate the target allied champion as being ''Worthy'', forming a {{tip|tether}} between you and them. Champions can only be designated as ''Worthy'' by one '''Knight's Vow''' at a time.",
    ...
    ["Kraken Slayer"] = {
        ...
        ["effects"] = {
            ["pass"] = {
                ["name"]        = "Bring It Down",
                ["unique"]      = true,
                ["description"] = "Basic attacks {{rd|[[on-hit]]|[[on-attack]]}} grant a stack for 3 seconds, up to 2 stacks. At 2 stacks, the next basic attack consumes all stacks to deal {{as|50 {{as|(+ 40% '''bonus''' AD)}} '''bonus''' true damage|true damage}} on-hit.",
            },
            ["mythic"]          = {
            	["as"]				= 10,
            }
    ...
    ["Locket of the Iron Solari"] = {
        ...
        ["tier"]                = 3,
        ["type"]                = {"Mythic"},
        ["limit"]               = "''Devotion's'' shield is reduced by 75% if the target was affected by another ''Devotion'' in the last 20 seconds.",
        ["maps"] = {
            ["sr"]              = true,
            ["ha"]              = true,
            ["nb"]              = true,
        ...
        ["effects"] = {
            ["act"] = {
                ["name"]        = "Devotion",
                ["unique"]      = true,
                ["description"] = "Grant you and allied champions within {{tip|cr|icononly=true}} 850 units a {{tip|shield}} for {{pp|180 to 330|type=target's level}} that decays over {{fd|2.5}} seconds.",
                ["cd"]          = "90",
            },
            ["pass"] = {
                ["name"]        = "Consecrate",
                ["unique"]      = true,
                ["description"] = "Grant allied champions (''excluding yourself'') within {{tt|850 units|center to edge}} {{as|3 '''bonus''' armor}} and {{as|3 '''bonus''' magic resistance}}.",
            },
    ...
    ["Lord Dominik's Regards"] = {
        ...
        ["effects"] = {
            ["pass"] = {
                ["name"]        = "Giant Slayer",
                ["unique"]      = true,
                ["description"] = "Deal {{pp|type='''maximum''' health difference|color=health|key=%|0 to 25 for 11|0 to 2500|formula=1% per 100 greater '''maximum''' health}} {{as|'''bonus''' physical damage|physical damage}} against enemy champions with greater {{as|'''maximum''' health}} than you.",
            },
        },
    ...
    ["Maw of Malmortius"] = {
        ...
        ["effects"] = {
            ...
            ["pass2"] = {
                ["unique"]      = true,
                ["description"] = "Triggering ''Lifeline'' also grants 12% life steal for 5 seconds. After 2 seconds into the duration, taking or dealing damage refreshes this effect to 3 seconds.",
            },
        },
        ["recipe"]              = {"Hexdrinker", "Pickaxe", "Long Sword"},
        ["buy"]                 = 2900,
    },
    ["Mejai's Soulstealer"] = {
        ["id"]                  = 3041,
    ...
    ["Mikael's Blessing"] = {
        ...
        ["effects"] = {
            ["act"] = {
                ["name"]        = "Purify",
                ["unique"]      = true,
                ["description"] = "Remove all {{tip|crowd control}} debuffs (except {{tip|Airborne}}, {{tip|Blind}}, {{tip|Disarm}}, {{tip|Ground}}, {{tip|Nearsight}}, and {{tip|Suppression}}) from yourself or the target allied champion and {{tip|heal}} the target for {{pp|100 to 180|type=target's level}}.",
    ...
    ["Moonstone Renewer"] = {
        ...
        ["effects"] = {
            ...
            ["mythic"]          = "8 increased heal for ''Starlit Grace''",
        },
        ["recipe"]              = {"Kindlegem", "Bandleglass Mirror"},
        ["buy"]                 = 2500,
    },
    ["Morellonomicon"] = {
        ...
        ["recipe"]              = {"Oblivion Orb", "Hextech Alternator", "Amplifying Tome"},
        ["buy"]                 = 3000,
    },
    ["Mosstomper Seedling"] = {
        ["id"]                  = 1103,
    ...
    ["Navori Quickblades"] = {
        ...
        ["tier"]                = 3,
        ["type"]                = {"Legendary"},
        ["itemlimit"]           = "Marksman Capstone",
        ["itemlimit2"]          = "Ability Haste Capstone",
        ["maps"] = {
            ["sr"]              = true,
            ["ha"]              = true,
            ["nb"]              = true,
        ...
        ["effects"] = {
            ["pass"] = {   
                ["name"]        = "Transcendence",
                ["unique"]      = true,
                ["description"] = "If you have at least {{as|40% critical strike chance}}, basic attacks [[on-attack]] reduce your basic abilities' '''current''' cooldowns by 15% of their remaining cooldowns.",
            },
            ["pass2"] = {   
                ["name"]        = "Impermanence",
                ["unique"]      = true,
    ...
    ["Oracle Lens"] = {
        ...
        ["effects"] = {
            ["act"] = {
                ...
                ["cd"]          = "{{pp|120 to 60|type=average champion level}}",
                ["range"]       = "750",
            },
        },
        ["buy"]                 = 0,
    ...
    ["Perfectly Timed Stopwatch"] = {
        ...
        ["tier"]                = 2,
        ["type"]                = {"Distributed", "Basic"},
        ["limit"]               = "Transforms into {{ii|Broken Stopwatch}} when activated, which cannot be activated again. Once broken, all future purchases are also broken. Upgrades cost {{g|500}} more than the {{ii|Stopwatch|real deal}}.",
        ["maps"]                = "=>Stopwatch",
        ["effects"] = {
            ["act"]             = "=>Stopwatch",
        },
    ...
    ["Primordial Dawn"] = {
        ...
        ["tier"]                = 4,
        ["type"]                = "=>Radiant Virtue",
        ["itemlimit"]           = "=>Radiant Virtue",
        ["limit"]               = "=>Radiant Virtue",
        ["ornn"]                = true,
        ["caption"]             = "{{sbc|{{ai|Master Craftsman|Ornn}}:}} All stats have been improved.",
        ["maps"]                = "=>Radiant Virtue",
        ["menu"]                = "=>Radiant Virtue",
        ...
        ["effects"] = {
            ["pass"]            = "=>Radiant Virtue",
            ["mythic"]          = "=>Radiant Virtue",
        },
        ["recipe"]              = {"Radiant Virtue"},
        ["buy"]                 = "=>Radiant Virtue",
    },
    ["Prowler's Claw"] = {
        ["id"]                  = 6693,
    ...
    ["Radiant Virtue"] = {
        ...
        ["effects"] = {
            ["pass"] = {   
                ["name"]        = "Guiding Light",
                ["unique"]      = true,
                ["description"] = "Upon casting your [[champion ability|ultimate]], you ''Transcend'' for 9 seconds. While ''Transcended'', increase your {{as|'''maximum''' health by 15%}} and cause you and all allies within {{tip|cr|icononly=true}} 1200 units to {{tip|heal}} for {{as|3% of your '''maximum''' health}} upon you ''Transcending'' and every 3 seconds thereafter.",
                ["cd"]          = "90",
            },
            ["mythic"]          = {
            	["hp"]			= 100,
    ...
    ["Randuin's Omen"] = {
        ...
        ["effects"] = {
            ...
            ["pass2"] = {   
                ...
                ["unique"]      = true,
                ["description"] = "Reduces incoming {{tip|critical strike|critical strike}} damage from basic attacks by 20%.",
            },
        },
    ...
    ["Ravenous Hydra"] = {
        ...
        ["effects"] = {
            ["pass"] = {
                ["name"]        = "Cleave",
                ["unique"]      = true,
                ["description"] = "Damaging basic attacks and {{tip|ability damage}} from [[champion ability|abilities]] deal {{rd|{{as|40% AD}}|{{as|20% AD}}}} {{as|physical damage}} to other enemies within 350 units of the target damaged. Can only hit each target once per attack or ability, and may only trigger once every 10 seconds from the same cast.",
            },
            ["pass2"] = {   
                ["name"]        = "Carnivorous",
                ["unique"]      = true,
                ["description"] = "Gain {{as|{{fd|0.5}} '''bonus''' attack damage}} whenever you kill a minion, doubled for kills against champions, large monsters, and large minions. This effect stacks up to 40 times, for a total of {{as|20 '''bonus''' attack damage}}. Lose 60% of stacks upon death.",
            },
        },
    ...
    ["Redemption"] = {
        ...
        ["tier"]                = 3,
        ["type"]                = {"Legendary"},
        ["limit"]               = "''Intervention's'' heal is reduced by 50% if the target was affected by another ''Intervention'' in the last 12 seconds.",
        ["maps"] = {
            ["sr"]              = true,
            ["ha"]              = true,
            ["nb"]              = true,
    ...
    ["Relic Shield"] = {
        ...
        ["effects"] = {
            ...
            ["pass2"] = {   
                ["name"]        = "Quest",
                ["unique"]      = true,
                ["description"] = "Earn {{g|500}} using this item to upgrade to {{ii|Targon's Buckler}}, gaining the ''Warding'' active with 3 wards in stock.",
            },
        },
        ["buy"]                 = 400,
        ["sellratio"]           = 0.4,
    ...
    ["Riftmaker"] = {
        ...
        ["effects"] = {
            ["pass"] = {   
                ...
                ["unique"]      = true,
                ["description"] = "For each second [[combat status|in combat]] with champions, deal 3% increased damage, stacking up to 3 times for a '''maximum''' of 9%. While this effect is fully stacked, convert 100% of the increased damage into {{as|true damage}}.",
            },
            ["mythic"]          = {
            	["ap"]				= 8,
            	["omnivamp"]		= 2,
    ...
    ["Runesteel Spaulders"] = {
        ...
        ["effects"] = {
            ...
            ["pass2"] = {
                ["name"]        = "Quest",
                ["unique"]      = true,
                ["description"] = "Earn {{g|500}} using this item to upgrade to {{ii|Pauldrons of Whiterock}}, increasing the ''Warding'' active to instead have 4 wards in stock.",
            },
        },
    ...
    ["Seeker's Armguard"] = {
        ...
        ["effects"] = {
            ["pass"] = {   
                ["name"]        = "Witch's Path",
                ["unique"]      = true,
                ["description"] = "Killing a unit grants {{as|{{fd|0.5}} '''bonus''' armor}}, up to a '''maximum''' of {{as|15|armor}} at 30 unit kills.",
            },
        },
    ...
    ["Seraph's Embrace"] = {
        ...
        ["effects"] = {
            ["pass"] = {   
                ["name"]        = "Awe",
                ["unique"]      = true,
                ["description"] = "Grants {{as|ability power}} equal to {{as|{{fd|2.5}}% '''bonus''' mana}}.",
            },
            ["pass2"] = {
                ["name"]        = "Lifeline",
                ["unique"]      = true,
    ...
    ["Silvermere Dawn"] = {
        ...
        ["effects"] = {
            ["act"] = {   
                ["name"]        = "Quicksilver",
                ["unique"]      = true,
                ["description"] = "Removes all {{tip|crowd control}} debuffs (except {{tip|Airborne}}) from your champion and grants 50% {{tip|tenacity}}, 50% {{tip|slow resist}}, and {{tip|ghosting}} for 3 seconds.",
                ["cd"]          = "90",
            },
        },
    ...
    ["Spear of Shojin"] = {
        ...
        ["tier"]                = 3,
        ["type"]                = {"Legendary"},
        ["itemlimit"]           = "Ability Haste Capstone",
        ["maps"] = {
        	["sr"]              = true,
            ["ha"]              = true,
            ["nb"]              = true,
        ...
        ["effects"] = {
            ["pass"] = {
            	["name"]        = "Dragonforce",
                ["unique"]      = true,
                ["description"] = "Gain {{rd|8 {{as|(+ 8% '''bonus''' AD)}}|6 {{as|(+ 6% '''bonus''' AD)}}}} basic ability haste, reduced{{ft|by 50%|to {{rd|4 {{as|(+ 4% '''bonus''' AD)}}|3 {{as|(+ 3% '''bonus''' AD)}}}}}}for {{tip|immobilize|immobilizing}} spells.",
            },
            ["pass2"] = {
            	["name"]        = "Exigency",
                ["unique"]      = true,
                ["description"] = "Gain up to {{rd|{{as|15%|ms}}|{{as|10%|ms}}}} {{as|'''bonus''' movement speed}} based on {{as|'''missing''' health}}, capped at {{as|67% '''missing''' health}}.",
            },
        },
        ["recipe"]              = {"Caulfield's Warhammer", "B. F. Sword","Kindlegem"},
        ["buy"]                 = 3400,
    },
    ["Spectral Sickle"] = {
    	["id"]                  = 3862,
        ...
        ["effects"] = {
            ...
            ["pass2"] = {
                ["name"]        = "Quest",
                ["unique"]      = true,
                ["description"] = "Earn {{g|500}} using this item to upgrade to {{ii|Harrowing Crescent}}, gaining the ''Warding'' active with 3 wards in stock.",
            },
        },
        ["buy"]                 = 400,
        ["sellratio"]           = 0.4,
    ...
    ["Spectre's Cowl"] = {
        ...
        ["effects"] = {
            ["pass"] = {   
                ["name"]        = "Incorporeal",
                ["unique"]      = true,
                ["description"] = "Gain {{as|150% '''base''' health regeneration}} after taking damage from a champion, with the duration equal to {{fd|33.{{recurring|3}}}}% of the damage taken, up to a maximum of 10 seconds."
                ,
            },
        },
    ...
    ["Spellthief's Edge"] = {
        ...
        ["effects"] = {
            ...
            ["pass2"] = {   
                ["name"]        = "Quest",
                ["unique"]      = true,
                ["description"] = "Earn {{g|500}} using this item to upgrade to {{ii|Frostfang}}, gaining the ''Warding'' active with 3 wards in stock.",
            },
        },
        ["buy"]                 = 400,
        ["sellratio"]           = 0.4,
    ...
    ["Steel Shoulderguards"] = {
        ...
        ["effects"] = {
            ...
            ["pass2"] = {   
                ["name"]        = "Quest",
                ["unique"]      = true,
                ["description"] = "Earn {{g|500}} using this item to upgrade to {{ii|Runesteel Spaulders}}, gaining the ''Warding'' active with 3 wards in stock.",
            },
        },
        ["buy"]                 = 400,
        ["sellratio"]           = 0.4,
    ...
    ["Sterak's Gage"] = {
        ...
        ["effects"] = {
            ...
            ["pass2"] = {   
                ["name"]        = "Lifeline",
                ["unique"]      = true,
                ["description"] = "If you would take damage that would reduce you below {{as|30% of your '''maximum''' health}}, gain a {{tip|shield}} equal to {{as|80% of '''bonus''' health}} that decays over {{fd|4.5}} seconds.",
                ["cd"]          = "60",
            },
        },
    ...
    ["Targon's Buckler"] = {
        ...
        ["effects"] = {
            ...
            ["pass2"] = {   
                ["name"]        = "Quest",
                ["unique"]      = true,
                ["description"] = "Earn {{g|500}} using this item to upgrade to {{ii|Bulwark of the Mountain}}, increasing the ''Warding'' active to instead have 4 wards in stock.",
            },
        },
        ["recipe"]              = {"Relic Shield"},
        ["buy"]                 = "=>Relic Shield",
    ...
    ["Tiamat"] = {
        ...
        ["effects"] = {
            ["pass"] = {   
                ["name"]        = "Cleave",
                ["unique"]      = true,
                ["description"] = "Basic attacks [[on-hit]] deal {{rd|{{as|40% AD}}|{{as|20% AD}}}} {{as|physical damage}} to other enemies within 350 units of the target.",
            },
        },
        ["recipe"]              = {"Pickaxe"},
        ["buy"]                 = 1200,
    ...
    ["Trinity Force"] = {
        ...
        ["effects"] = {
            ["pass"] = {   
                ...
                ["unique"]      = true,
                ["description"] = "Basic attacks grant {{as|20 '''bonus''' movement speed}} for 3 seconds and, if the target is a champion or a structure, increase {{as|'''base''' attack damage by 4%}} for the same duration, stacking up to 5 times for a {{as|20% increase|attack damage}}. Stacks expire by one every {{fd|0.5}} seconds when the duration ends.",
            },
            ["pass2"] = {
                ["name"]        = "Spellblade",
                ["unique"]      = true,
    ...
    ["Turbo Chemtank"] = {
        ...
        ["recipe"]              = {"Kindlegem", "Negatron Cloak", "Ruby Crystal"},
        ["buy"]                 = 2800,
    },
    ["Turret Plating"] = {
        ["id"]                  = 1515,
    ...
    ["Verdant Barrier"] = {
        ...
        ["effects"] = {
            ["pass"] = {   
                ["name"]        = "Adaptive",
                ["unique"]      = true,
                ["description"] = "Killing a unit grants {{as|{{fd|0.3}} '''bonus''' magic resistance}}, up to a '''maximum''' of {{as|9|magic resistance}} at 30 unit kills.",
            },
        },
    ...
    ["Warmog's Armor"] = {
        ...
        ["effects"] = {
            ["pass"] = {
                ["unique"]      = true,
                ["description"] = "Grants ''Warmog's Heart'' if you have at least {{as|1100 '''bonus''' health}}.",
            },
            ["pass2"] = {
                ["name"]        = "Warmog's Heart",
                ["unique"]      = true,
    ...
    ["Zeke's Convergence"] = {
        ...
        ["effects"] = {
            ["act"] = {   
                ["name"]        = "Conduit",
                ["unique"]      = true,
                ["description"] = "Designate the target allied champion as the ''Accomplice'', forming a {{tip|tether}} between you and them. Champions can only be designated as the ''Accomplice'' by one '''Zeke's Convergence''' at a time.",
                ["range"]       = "{{tip|cr|icononly=true}} 1250",
                ["cd"]          = "60",
            },
            ["pass"] = {
                ["name"]        = "Convergence",
                ["unique"]      = true,
                ["description"] = "{{tip|Immobilize|Immobilizing}} enemy champions marks them for 8 seconds. Your ''Accomplice's'' basic attacks [[on-hit]] and ability hits against marked enemies fire a missile at them that deals {{as|{{pp|30 to 70}} {{as|(+ {{fd|7.5}}% AP)}} {{as|(+ {{fd|1.5}}% '''maximum''' health)}} '''bonus''' magic damage|magic damage}} upon arrival.",
            },
        },
...
local jsonString = json.encode(data, { indent = true, recurse = true })
print(jsonString)